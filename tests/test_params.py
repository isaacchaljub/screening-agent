...
def test_anthropic_thinking_only_set_when_requested():
    off = build_params(ANTHROPIC_SPEC, NeutralParams(thinking=False))
    on = build_params(ANTHROPIC_SPEC, NeutralParams(thinking=True))
